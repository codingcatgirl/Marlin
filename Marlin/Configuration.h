...
#define STRING_CONFIG_H_AUTHOR "(Laura, Foxy Printer 2.1 config)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, 0, -0.6 }
...
#define Y_MIN_POS -8
#define Z_MIN_POS 0
#define X_MAX_POS 283-12-5
#define Y_MAX_POS 237-8-5
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 20             // Set Mesh bounds as an inset region of the bed (OVERRIDEN!!)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 6), (Y_MAX_POS - 1), 5 }
