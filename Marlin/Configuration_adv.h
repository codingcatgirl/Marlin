...
#define HOMING_BACKOFF_POST_MM { 5, 5, 0 }  // (mm) Backoff from endstops after homing
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  18, 0 }, { X_BED_SIZE-18, 0 }, { X_BED_SIZE-18, Y_BED_SIZE }, { 18, Y_BED_SIZE } }
 ...
 */
  ...
  #define MESH_MIN_X 22
  #define MESH_MIN_Y 10
  #define MESH_MAX_X X_BED_SIZE - (22)
