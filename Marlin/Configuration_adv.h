...
// @section bltouch
   ...
   */
  //#define BLTOUCH_HS_MODE  // was enabled - Laura
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 2*60, 1*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel  // z was 2 - Laura
